        ...
        <div>
            ...
            <div className="main-margin about-frame">
                ...
                <p>
                    ...
                    &nbsp;协议在 <a href="https://github.com/pkuhelper-web/pku-syllabus" target="_blank" rel="noopener noreferrer">GitHub</a> 开源。
                    本版本修复了选课表新增P/NP列导致的解析问题，源码见&nbsp;
                    <a href="https://github.com/Morrow-Yang/pku-syllabus" target="_blank" rel="noopener noreferrer">此处</a>。
                </p>
                <p>
